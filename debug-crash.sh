...
case $choice in
    1)
        find_crash_details "30 minutes ago"
        ;;
    2)
        find_crash_details "2 hours ago"
        ;;
    3)
        find_crash_details "6 hours ago"
        ;;
    4)
        echo "Enter timeframe (e.g., '1 hour ago', '45 minutes ago'):"
        read timeframe
        find_crash_details "$timeframe"
        ;;
    5)
        find_crash_details "2 hours ago"
        analyze_coredump
...
echo "Copy the relevant sections above and share them for debugging."
echo "Look especially for:"
echo "- Segfaults or crashes with our extension name"
echo "- JavaScript/GJS errors"
echo "- Modal/Dialog related errors"
echo "- The timeline around session termination"